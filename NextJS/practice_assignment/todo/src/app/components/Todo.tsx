...
const Todo = () => {
  ...
  // Use for page onload data will not lost
  useEffect(() => {
  ...
  return (
    <div className="h-full w-full flex justify-center items-center flex-col space-y-10">
      <div className="p-4 flex flex-row space-y-2 text-black">
        <textarea
          value={todoName}
          ...
          return (
            <div className="flex justify-between items-center w-1/3 my-2 bg-gray-600 p-4 bg-opacity-30 border border-solid border-gray-800 rounded">
              ...
              <button
                ...
                className="bg-blue-600 p-2 rounded hover:bg-blue-800 text-white font-bold"
              >
                Delete
              </button>
            </div>
