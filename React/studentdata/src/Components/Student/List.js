...
const List = () => {
    ...
    useEffect(() => {
        async function getAllStudent() {
            try {
                const students = await axios.get("http://localhost:3004/student")
    ...
    const handleDelete = async id => {
        await axios.delete(`http://localhost:3004/student/${id}`);
                ...
                <Table>
                    <TableHead>
                        <TableRow style={{ backgroundColor: "#616161" }}>
                            ...
                            <TableCell align="center" className={classes.tableHeadCell}>Number</TableCell>
